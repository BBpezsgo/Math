...
namespace Maths
{
        ...
        IEqualityOperators<Point4, Point4, bool>
    {
        ...
        public static implicit operator UnityEngine.Vector4(Point4 v) => new(v.X, v.Y, v.Z, v.W);
        public static implicit operator Point4(UnityEngine.Vector4 v) => new(v.x, v.y, v.z, v.w);
